...
//  Convertit
//
//  Created by Hiroki on 2019/02/24.
    ...
    func calculateConversion() {
        guard let inputValue = Double(userInput.text!) else {
            ...
            case "liters to quarts":
                outputValue = inputValue * 1.05669
            default:
                showAlert(title: "Unexpected Error", message: "Contact the Developer and share that the \"\(conversionString)\" cannot be identified.")
            }
